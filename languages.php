...
<tbody><tr><td>
        ...
        <tr>
            ...
            <td class="medium" valign="middle" style="line-height: 1.2; padding-bottom: 8px;">
                <div style="text-align: center; padding-bottom: 4px; font-weight: bold; color: #000077;">
                    "Highly professional personnel (Joe, Jolita, Isabelle &amp; Eleonora are also great people to work with) &amp; highly efficient organisation (fully automated and prompt invoicing system)."
                </div>
                ...
                <table align="right" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
                        ...
                        <td class="main_selected_tab">
                            <a class="main_selected_tab" href="languages.php">Languages</a>
                        </td>
    ...
    <form action="top.php?" method="post">
        ...
        <table width="1000" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr><td>
                    <h1>Language Combinations <span><a style="font-size:12px;text-decoration:none;font-weight:normal;" href="top_help.php#rates_and_languages_pairs" target="top_help">[?]</a>
</span></h1>
                </td>
    ...
    <form action="top.php?" method="post">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    <td><select name="source" style="width: 180px;"><option value=""></option><option value="Afrikaans">Afrikaans
                    ...
                    <td>&nbsp;</td>
                                            ...
                                            <td><select name="target" style="width: 180px;"><option value="Afrikaans">Afrikaans
</option></select></td>
                    
                    <td>&nbsp;</td>
                    <td style="border: none;"><input type="submit" name="add_combo" value="Add Combination"></td>
                </tr>
            </tbody></table>
        </div>
    </form>
            ...
            <div class="section">
        <h2>Review/edit existing language pairs :</h2>


        <table class="combo_info" width="990">
        <tbody><tr>
            <th width="90">Status <a style="text-decoration:none;" href="top_help.php#language_status" target="top_help" title="Status of language in selection procedure: pending approval, approved ...">[?]</a></th>
            <th style="text-align: left;">Source &gt; Target</th>
            <th width="90">Your<br>Rate&nbsp;<a style="text-decoration:none;" href="top_help.php#rate" target="top_help" title="Gross Euro per source word (or per source Asian character)">[?]</a></th>
            <th width="90">Suggested<br>Rate&nbsp;<a style="text-decoration:none;" href="top_help.php#sugg_rate" target="top_help" title="Accept this rate to maximize the amount of work we can offer you">[?]</a></th>
            <th colspan="2">Words&nbsp;per<br>Day&nbsp;<a style="text-decoration:none;" href="top_help.php#turnaraound" target="top_help" title="">[?]</a></th>
        </tr>
            </tbody></table>
    </div>
    </td></tr>
